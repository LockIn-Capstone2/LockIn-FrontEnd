...
function CalendarDayButton({ className, day, modifiers, ...props }) {
  ...
  useEffect(() => {
    if (modifiers && modifiers.focused && ref.current) {
      ref.current.focus()
    }
  }, [modifiers && modifiers.focused])
  ...
  return (
    <Button
      ...
      data-range-start={modifiers && modifiers.range_start}
      data-range-end={modifiers && modifiers.range_end}
      data-range-middle={modifiers && modifiers.range_middle}
      className={cn(
