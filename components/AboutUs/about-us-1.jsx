...
const defaultValues = [
  {
    title: "Innovation",
    description:
      "We continuously develop new tools and features to help students stay on top of their coursework and grades, making learning more effective and engaging.",
    icon: "Lightbulb",
  },
  {
    title: "Collaboration",
    description:
      "We believe in fostering a collaborative environment where students, teachers, and tutors can work together to ensure academic success and growth.",
    icon: "Users",
  },
  {
    title: "Excellence",
    description:
      "We empower students to strive for academic excellence by providing resources, insights, and support to help them maintain a high GPA.",
    icon: "Sparkles",
  },
  {
    title: "Impact",
...
export default function AboutUs1() {
  const aboutData = {
    title: "About Us",
    subtitle:
      "Empowering students worldwide to stay on track with their studies and maintain a high GPA.",
    mission:
      "Our mission is to provide students with the tools, resources, and support they need to excel academically and achieve their educational goals.",
    vision:
      "We envision a future where every student, regardless of background or location, has the ability to succeed in their academic journey and unlock their full potential.",
  ...
  return (
    <section className="relative w-full overflow-hidden pt-20">
      <Spotlight
        gradientFirst="radial-gradient(50% 50% at 50% 50%, rgba(71, 73, 122, 0.05) 0%, rgba(133, 135, 176, 0.1) 80%, transparent 100%)"
        gradientSecond="radial-gradient(68.54% 68.72% at 55.02% 31.46%, rgba(60, 88, 153, 0.3) 0%, rgba(163, 171, 186, 0.3) 50%, transparent 80%)"
        gradientThird="radial-gradient(50% 50% at 50% 50%, rgba(71, 73, 122, 0.05) 0%, rgba(133, 135, 176, 0.1) 80%, transparent 100%)"
      />
