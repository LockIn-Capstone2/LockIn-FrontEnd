    ...
    <footer className="relative z-10 mt-8 w-full overflow-hidden pt-16 pb-8">
      <style jsx global>{`
        .glass {
          ...
          background: radial-gradient(circle, #fff9 0%, #ccd9f04d 60%, #C4C5D9 100%);
        ...
        .glass:where(.dark, .dark *) {
          ...
          background: radial-gradient(circle, #ffffff1a 0%, #1e00001a 60%, #3c5899 100%) !important;
      ...
      <div className="pointer-events-none absolute top-0 left-1/2 z-0 h-full w-full -translate-x-1/2 select-none">
        <div className="absolute -top-32 left-1/4 h-72 w-72 rounded-full bg-gray-500/20 blur-3xl"></div>
        <div className="absolute right-1/4 -bottom-24 h-80 w-80 rounded-full bg-gray-500/20  blur-3xl"></div>
      </div>
      <div className="glass relative mx-auto flex max-w-6xl flex-col items-center gap-8 rounded-2xl px-6 py-10 md:flex-row md:items-start md:justify-between md:gap-12">
        <div className="flex flex-col items-center md:items-start">
          <a href="#" className="mb-4 flex items-center gap-2">
            <span className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-[#3c5899] to-[#A3ABBA] text-2xl font-extrabold text-white shadow-md">
              <svg
            ...
            <span className="bg-gradient-to-br from-[#3c5899] to-[#A3ABBA] bg-clip-text text-xl font-semibold tracking-tight text-transparent">
              LockIn
            </span>
          </a>
          <p className="text-foreground mb-6 max-w-xs text-center text-sm md:text-left">
            An innovative platform designed to assist students globally in
            staying organized, managing coursework, and tracking grades, all
            aimed at achieving academic excellence and maintaining a strong
            GPA."
          </p>
          <div className="mt-2 flex gap-3 text-[#A3ABBA]">
            <a
              href="#"
              aria-label="Twitter"
        ...
        <nav className="flex w-full flex-col gap-9 text-center md:w-auto md:flex-row md:justify-end md:text-left">
          <div>
            <div className="mb-3 text-xs font-semibold tracking-widest text-[#3c5899] uppercase">
              Product
            </div>
      ...
      <div className="text-foreground relative z-10 mt-10 text-center text-xs">
        <span>&copy; 2025 LockIn. All rights reserved.</span>
      </div>
    </footer>
  );
}
